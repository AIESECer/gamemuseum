...
<div id="corps">
<h1>Le Site - Contact </h1>
<p><?php include('site/pub_grand.php'); ?>&nbsp;</p>
<?
/* PARAMETRAGE DU SCRIPT */
/* ENTREZ VOTRE ADRESSE EMAIL ENTRE LES GUILLEMETS*/

$dest="yami_ne1@hotmail.com";

$reponse=StripSlashes("Votre message a bien ete envoyé au webmaster d'Emul-Age,vous aurez une reponse dans mes plus bref delais. Merci ");
